# -*- coding: utf-8 -*-
"""
產生：ForestMRV 智慧森林監測平臺 — 完整操作手冊（對應 prod v2.11.78）
...
圖片策略：
  ...
  - 新功能（v2.11.69→78）無截圖者 → add_placeholder 留佔位框，並自動彙整成
...
PH_SEQ = [0]   # 佔位圖序號（依文件出現順序，與是否已補圖無關）
...
add_subtitle(doc, "對應正式版本 v2.11.79", size=12)
add_subtitle(doc, "中華民國 115 年 6 月", size=12)
doc.add_paragraph()
