...
//   ?v=21145 -> ?v=21146 全檔。
const CACHE = 'forest-monitor-v2.11.72';  // v2.11.72：複查野外清單上期值加活立木快照回退（既有樣區缺凍結歷史時不再整欄空白）；v2.11.71：P5b 開新期蓋印 tree.priorSnapshot + 可列印複查野外清單；以下歷史
