...
import { fb, $, $$, el, toast, state, isReviewer, anonName, userLabel, twd97ToWgs84, wgs84ToTwd97 } from './app.js?v=21180';
// v2.3：階段 2 — 進度 KPI 用全 6 子集合 verified 比例
import { computeProgress, STATUS, STATUS_META } from './project-status.js?v=21180';
// v2.7.17：QAQC 工作流（給匯出 QAQC sheet 使用）
// v2.8.1：tree-level QAQC（給匯出立木 QAQC sheet 使用）
import { getPlotQaqcStatus, getTreeQaqcStatus, QAQC_STATUS_META, RESOLUTION_LABEL, computeErrorStats, computeTreeErrorStats, DEFAULT_QAQC_CONFIG } from './plot-qaqc.js?v=21180';
// v2.10.8（backlog #13）：公式來源徽章 — per-plot dashboard reviewer 透明度
import { getEquationBadge } from './species-equations.js?v=21180';
// v2.11.19：irregular plot vertices 轉換用
import { vertsToArrays } from './plot-polygon.js?v=21180';
// v2.11.22：地圖分頁「✏️ 編輯專案 / 上傳邊界」按鈕入口（補 v2.11.19 漏掉的 edit project 入口）
// v2.11.70（I-6）：複查報表用 derivePlotPeriods 取期別標籤
import { openProjectForm, derivePlotPeriods } from './forms.js?v=21180';
