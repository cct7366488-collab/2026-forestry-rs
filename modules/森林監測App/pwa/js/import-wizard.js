...
import { fb, $, $$, el, toast, openModal, closeModal, state, twd97ToWgs84, calcTreeMetrics } from './app.js?v=21173';
// v2.7.4：用真實 TREES dict 比對未知樹種（取代原 7 種 mock KNOWN_SPECIES）
import { TREES } from './species-dict.js?v=21173';
// I-1（v2.11.70）：批次匯入也 write-through 當期 measurement 歷史快照（共用 forms 純函式 builder）
import { buildMeasurementSnapshot } from './forms.js?v=21173';
