...
import { firebaseConfig } from "../firebase-config.js?v=21005";
import * as forms from "./forms.js?v=21005";
import * as analytics from "./analytics.js?v=21005";
import * as importWizard from "./import-wizard.js?v=21005";
import { renderTreeDistribution } from "./distribution.js?v=21005";   // v2.6.2：立木分布散布圖
import { renderSpeciesDict, disposeSpeciesDict } from "./species-admin.js?v=21005";   // v2.7.10：admin 樹種字典管理
// v2.7.17：reviewer QAQC 工作流
// v2.8.1：tree-level QAQC（抽樣 / 重測 / 誤差 / 處置 / gate）
import { DEFAULT_QAQC_CONFIG, computeTargetSampleSize, computeTreeSampleSize, pickRandomSample, getPlotQaqcStatus, getTreeQaqcStatus, QAQC_STATUS_META, RESOLUTION_LABEL, checkApprovalGate, checkTreeApprovalGate, computeErrorStats, computeTreeErrorStats, defaultQaqc, defaultTreeQaqc } from "./plot-qaqc.js?v=21005";
import { calcTreeMetrics as calcTreeMetricsImpl, speciesParamsLabel as speciesParamsLabelImpl } from "./species-equations.js?v=21005";
// v2.3：階段 2 — 狀態機 + 自動偵測送審；v2.7：階段 3 — Reviewer 完成審查
import { STATUS, STATUS_META, AUTO_LOCK_REASON_LABEL, statusBadgeHTML, ensureStatusMigrated, applyStatusAfterManualLock, applyStatusAfterReviewerApprove, applyStatusRevertVerified, computeProgress } from "./project-status.js?v=21005";
...
async function triggerRectConversion(projectId) {
  ...
  try {
    const m = await import('./migration-v2715.js?v=21005');
    toast('掃描中...');
