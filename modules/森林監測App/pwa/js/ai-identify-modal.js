...
import { el, toast, isSystemAdmin, isPi } from './app.js?v=21131';
import { identifySpecies, getApiKey, setApiKey, clearApiKey, getProxyUrl, setProxyUrl, clearProxyUrl, getEffectiveApiKey, getEffectiveProxyUrl, loadGlobalAiConfig, setGlobalAiConfig, getLlmKey, setLlmKey, clearLlmKey, getEffectiveLlmKey, getEffectiveLlmModel, enrichWithLLM, resizeImage, matchToLocalSpecies, lookupChineseName, suggestSpeciesFromAi, LLM_MODELS } from './ai-species.js?v=21131';
import { loadSpeciesCache } from './species-picker.js?v=21131';
...
export async function openAiIdentifyModal({ onPick, forceSetup = false } = {}) {
  // v2.11.26：dedup — 已開啟的 AI modal 直接 return，避免按鈕快速連點累積多個 wrap
